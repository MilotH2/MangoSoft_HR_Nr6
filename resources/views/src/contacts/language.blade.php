...
<div class="row" style="padding:0 15px;">
    <div class="col-12" v-for="language of languages" style="padding:15px;margin-bottom:5px;">
...
<div class="row" style="padding:0 15px;">
    <div class="col-2 text-center" v-if="showAddLang==0">
        <button class="btn btn-info btn-sm" style="width:100%;"
                v-if="showAddLang==0" @click="showAddLang=1">
            <i class="fa fa-plus"></i> Add
        </button>
    </div>
    <div class="col-412 v-if="showAddLang==1" style="    padding: 20px;
    background: rgb(247 247 247);
    border-radius: .25rem;">
        <p><i class="fa fa-plus-circle"></i> Add new Language</p>
